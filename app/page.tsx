      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-[1016px] mx-auto px-[64px]">
          ...
          <div className="space-y-6 pb-[32px]">
            ...
            {/* Cards Section */}
            <section>
              <div className="carousel-container overflow-x-auto flex gap-[12px] no-scrollbar">
                {/* Card 1 */}
                <a
                ...
                {/* Card 3 */}
                <a
                  aria-label="THB balance. 30000.00 THB. Account details ending in 345-67."
                  className="balanceCard bg-gray-100 rounded-2xl p-4 w-[256px] flex-shrink-0 h-[208px] flex flex-col justify-between"
                  href="#"
                >
                  {/* Top Section with Icon */}
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <img
                        src="th-flag-square-250.png" // Adjust to the actual path of the icon
                        alt="TH Flag"
                        className="w-12 h-12 rounded-full"
                      />
                      <span className="text-gray-700 text-lg font-bold ml-3">
            ...
            <section>
              <div className="flex justify-between items-end">
                <h3 className="text-2xl font-bold mt-[16px]">Transactions</h3>
                <a
                  href="#"
              ...
              <ul className="mt-4">
                {/* Transaction Row 1 */}
                <li className="bg-white rounded-lg flex items-center justify-between py-[16px]">
                  {/* Left Section */}
                  <div className="flex items-center">
                    <div className="flex items-center justify-center bg-gray-100 rounded-full w-12 h-12 mr-4">
                      <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                      >
                        <path d="M12.771 7.115a.83.83 0 0 0-1.2 0L3 15.686l1.2 1.2 7.971-7.971 7.972 7.971 1.2-1.2z" />
                      </svg>
                    </div>
                    <div>
                  ...
                  <div className="text-right">
                    <p className="font-bold text-gray-900">355 USD</p>
                    <p className="text-sm text-gray-500">482.87 SGD</p>
                  </div>
                </li>

                {/* Transaction Row 2 */}
                <li className="bg-white rounded-lg py-4 flex items-center justify-between">
                  <div className="flex items-center">
                    <div className="flex items-center justify-center bg-gray-100 rounded-full w-12 h-12 mr-4">
                      <svg
                        className="w-6 h-6 text-gray-500"
                  ...
                  <div className="text-right">
                    <p className="font-bold text-gray-900">1,000.00 CNY</p>
                    <p className="text-sm text-gray-500">186.02 SGD</p>
                  </div>
                </li>
                ...
                <li className="bg-white rounded-lg py-4 flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-medium text-gray-800">JTY Maritime</p>
                      <p className="text-sm text-gray-500">
                        Sent • 31 Dec 2024
                      </p>
                    </div>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-sm text-gray-500">312.65 SGD</p>
                  </div>
                </li>
              </ul>
            </section>
